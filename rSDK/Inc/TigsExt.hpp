 ...
 *		TigsExt.hpp
 *
 *		Functions for the RunData SDK (made for the MMFireSDK)
...
_inline TCHAR* GetStringSpace(RunData *,int);	// Get temporary string space from MMF
_inline TCHAR* GetStringSpaceOld(RunData *,int);	// Get temporary string space from MMF (pre-MMF1.5)
...
_inline TCHAR* GetStringSpace(RunData * rdPtr, int size)
...
_inline TCHAR* GetStringSpaceOld(RunData * rdPtr, int size)
